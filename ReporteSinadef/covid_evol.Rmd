...
colnames(full) <- c("sexo", "edad", "tiempo.edad", "pais", "departamento",
...
## 3. Exceso desagregado por sexo y edad

```{r desagregado}
# Limpiar solo edad en anos

temp <- full[full$tiempo.edad == "AÑOS" & full$edad != "SIN REGISTRO", ]
...
## 4. Evolución del número de fallecidos diarios por departamento
...
## 5. Evolución del número de fallecidos diarios por provincia (más de 140000 habitantes)
