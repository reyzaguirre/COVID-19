...
url.sinadef <- "https://cloud.minsa.gob.pe/s/NctBnHXDnocgWAg/download?path=%2F&files=SINADEF_DATOS_ABIERTOS_14022021.xlsx"
...
ds$dif <- ds$pais - lb
texto <- paste("Exceso con respecto a la línea roja:", round(sum(ds$dif)))
