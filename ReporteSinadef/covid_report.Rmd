...
#url.sinadef <- "https://cloud.minsa.gob.pe/s/NctBnHXDnocgWAg/download?path=%2F&files=SINADEF_DATOS_ABIERTOS_25072020.xlsx"
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1)  +
  geom_vline(xintercept = as.Date("2020-05-30", "%Y-%m-%d"), linetype = 2, color = 4, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1) +
  geom_vline(xintercept = as.Date("2020-07-08", "%Y-%m-%d"), linetype = 2, color = 4, size = 1.5)
