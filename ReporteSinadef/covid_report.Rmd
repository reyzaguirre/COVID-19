...
#url.sinadef <- "https://cloud.minsa.gob.pe/s/NctBnHXDnocgWAg/download?path=%2F&files=SINADEF_DATOS_ABIERTOS_21072020.xlsx"
...
# Aumentar primeros 70 días 2020 a la línea base

temp <- full.nv[full.nv$ano == 2020 & full.nv$fecha < "2020-03-11", ]
ds <- docomp("count", "pais", "prov2", dfr = temp, method = 'slow')
ds$pais <- ds$pais / 70 * as.numeric(ultimo.fecha - as.Date("2020-01-01"))
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1)  +
  geom_vline(xintercept = as.Date("2020-05-31", "%Y-%m-%d"), linetype = 2, color = 4, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1) +
  geom_vline(xintercept = as.Date("2020-06-27", "%Y-%m-%d"), linetype = 2, color = 4, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1) +
  geom_vline(xintercept = as.Date("2020-05-28", "%Y-%m-%d"), linetype = 2, color = 4, size = 1.5) +
  geom_vline(xintercept = as.Date("2020-06-28", "%Y-%m-%d"), linetype = 2, color = 3, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  geom_vline(xintercept = as.Date("2020-06-23", "%Y-%m-%d"), linetype = 2, color = 7, size = 1.5) +
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1)  +
  geom_vline(xintercept = as.Date("2020-07-05", "%Y-%m-%d"), linetype = 2, color = 4, size = 1.5)
...
niveles <- c("55 a 64", "65 a 74", "45 a 54", "35 a 44", "75 y más", "0 a 35")
