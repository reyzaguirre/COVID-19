...
url.sinadef <- "https://cloud.minsa.gob.pe/s/NctBnHXDnocgWAg/download?path=%2F&files=SINADEF_DATOS_ABIERTOS_15072020.xlsx"
...
ggplot(ds, aes(fecha, pais)) +
  ...
  geom_vline(xintercept = as.Date("2020-06-18", "%Y-%m-%d"), linetype = 2, color = 3, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1)  +
  geom_vline(xintercept = as.Date("2020-05-12", "%Y-%m-%d"), linetype = 2, color = 3, size = 1.5) +
  geom_vline(xintercept = as.Date("2020-06-08", "%Y-%m-%d"), linetype = 2, color = 7, size = 1.5) +
  geom_vline(xintercept = as.Date("2020-07-10", "%Y-%m-%d"), linetype = 2, color = 2, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1)  +
  geom_vline(xintercept = as.Date("2020-06-30", "%Y-%m-%d"), linetype = 2, color = 3, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  geom_vline(xintercept = as.Date("2020-07-03", "%Y-%m-%d"), linetype = 2, color = 7, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1)  +
  geom_vline(xintercept = as.Date("2020-06-02", "%Y-%m-%d"), linetype = 2, color = 3, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1) +
  geom_vline(xintercept = as.Date("2020-05-05", "%Y-%m-%d"), linetype = 2, color = 3, size = 1.5) +
  geom_vline(xintercept = as.Date("2020-05-31", "%Y-%m-%d"), linetype = 2, color = 7, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1) +
  geom_vline(xintercept = as.Date("2020-05-18", "%Y-%m-%d"), linetype = 2, color = 3, size = 1.5) +
  geom_vline(xintercept = as.Date("2020-06-12", "%Y-%m-%d"), linetype = 2, color = 7, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1) +
  geom_vline(xintercept = as.Date("2020-06-25", "%Y-%m-%d"), linetype = 2, color = 3, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1) +
  geom_vline(xintercept = as.Date("2020-05-02", "%Y-%m-%d"), linetype = 2, color = 3, size = 1.5) +
  geom_vline(xintercept = as.Date("2020-05-17", "%Y-%m-%d"), linetype = 2, color = 7, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1) +
  geom_vline(xintercept = as.Date("2020-07-09", "%Y-%m-%d"), linetype = 2, color = 3, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1)  +
  geom_vline(xintercept = as.Date("2020-05-23", "%Y-%m-%d"), linetype = 2, color = 3, size = 1.5) +
  geom_vline(xintercept = as.Date("2020-06-06", "%Y-%m-%d"), linetype = 2, color = 7, size = 1.5) +
  geom_vline(xintercept = as.Date("2020-06-21", "%Y-%m-%d"), linetype = 2, color = 2, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1)  +
  geom_vline(xintercept = as.Date("2020-07-07", "%Y-%m-%d"), linetype = 2, color = 3, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1)  +
  geom_vline(xintercept = as.Date("2020-06-23", "%Y-%m-%d"), linetype = 2, color = 3, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1) +
  geom_vline(xintercept = as.Date("2020-07-10", "%Y-%m-%d"), linetype = 2, color = 3, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1) +
  geom_vline(xintercept = as.Date("2020-05-23", "%Y-%m-%d"), linetype = 2, color = 3, size = 1.5) +
  geom_vline(xintercept = as.Date("2020-06-10", "%Y-%m-%d"), linetype = 2, color = 7, size = 1.5)
...
ggplot(ds, aes(fecha, pais)) +
  ...
  annotate(geom = "text", x = as.Date("2020-01-01", "%Y-%m-%d"), y = max(ds$pais),
           label = texto, size = 4.2, color = "darkblue", hjust = 0, vjust = 1) +
  geom_vline(xintercept = as.Date("2020-07-01", "%Y-%m-%d"), linetype = 2, color = 3, size = 1.5)
