...
full <- full[, c("SEXO", "EDAD", "TIEMPO.EDAD", "PAIS.DOMICILIO", "PROVINCIA.DOMICILIO",
                 "DISTRITO.DOMICILIO", "FECHA", "AÑO", "MES", "MUERTE.VIOLENTA")]
colnames(full) <- c("sexo", "edad", "unidad", "pais", "provincia",
