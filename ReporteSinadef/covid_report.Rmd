...
url.sinadef <- "https://cloud.minsa.gob.pe/s/NctBnHXDnocgWAg/download?path=%2F&files=SINADEF_DATOS_ABIERTOS_25062020.xlsx"
...
```{r instrucción_femenino}

# Limpiar solo instrucción definida femenino

temp <- full.nv[!(full.nv$educa == "IGNORADO" | full.nv$educa == "SIN REGISTRO") & full.nv$sexo == "FEMENINO", ]
...
```{r instrucción_masculino}

# Limpiar solo instrucción definida femenino

temp <- full.nv[!(full.nv$educa == "IGNORADO" | full.nv$educa == "SIN REGISTRO") & full.nv$sexo == "MASCULINO", ]
